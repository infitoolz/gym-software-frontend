            ...
            <div className="wpd-topbar">
              <div className="wpd-breadcrumb-area">
                <button type="button" className="wpd-back-btn" onClick={goBack}>
                  ...
                  <span>{currentRole === "USER" ? "Dashboard" : "Back to Plans"}</span>
                </button>
              </div>

              <div className="d-flex align-items-center gap-3">
                <div className="text-end d-none d-sm-block">
                  <h3 className="mb-0 fw-bold">{currentRole === "USER" ? "My Workout Plan" : "Workout Detail"}</h3>
                    ...
                    <div className="wpd-hero-media" onClick={() => setLightboxImage(coverSrc)}>
                      {imageList.length > 1 ? (
                        ...
                        <div className="d-flex align-items-center justify-content-center h-100 text-muted">
                          ...
                          <span>No cover image attached</span>
                        </div>
                      )}
